...
# 에러 사항
- 아래의 명령어를 입력했을 때 `Suricata`에서 연결을 끊거나, 공백이 응답으로 돌아오는 것 같은 문제가 발생
```bash
echo '{"type": "ADD_RULE", "rule": "alert tcp any any -> any any (msg:\"TEST RULE 1: LLM Generated Test\"; sid:900000001; rev:1;)", "sid": 900000001}' | nc 192.168.0.10 10002
```
